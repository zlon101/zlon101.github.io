...
React Fiber 是 React 16 中引入的一种新的协调算法，被称为 `Fiber Reconciler`，基于` Fiber` 节点实现，支持可中断异步更新。
...
调度器（Scheduler）、协调器（Reconcilers）、渲染器（Rendered）
...
![fiber-tree-diagram](/Users/apple/workspace/TyporaNotes/React/assets/源码/fiber-tree-diagram.png)
