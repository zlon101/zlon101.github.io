...
[如何编译生成apk](https://instamobile.io/android-development/generate-react-native-release-build-android/) 

有 React Native CLI 和 Android Studio 两种方式

### [React Native CLI](https://github.com/react-native-community/cli?tab=readme-ov-file) 
...
修改 `android/app/build.gradle` 中 `signingConfigs` 配置，（确保 `signingConfigs` 配置块在 `buildTypes` 之前）

2. 创建 `android/app/src/main/assets`（若没有）
...
- [React Native CLI](https://github.com/react-native-community/cli?tab=readme-ov-file) 
- [React Native Directory](https://reactnative.directory/?search=clipboard) 
- [react-native 组件库](https://juejin.cn/post/7046016631788535816) 
- [react-native 组件库](https://juejin.cn/post/7170606687835914271) 
- [React Navigation](https://reactnavigation.org/docs/getting-started/) 
- [@react-native-async-storage/async-storage](https://github.com/react-native-async-storage/async-storage?tab=readme-ov-file)：异步、未加密、持久、键值存储系统


# Flutter

# [Tauri](https://v2.tauri.app/blog/tauri-20/) 
...
[tauri会是 Electron 的替代方案？](https://mp.weixin.qq.com/s/sMVS6xTv6qrcQp1o7uZOjQ) 

[Tauri：将JavaScript与Rust混用于GUI桌面应用程序](https://mp.weixin.qq.com/s/XHSapcSq-I6pYjRAL2xL4g) 

# Weex

vue 技术

# [taro](https://github.com/NervJS/taro?tab=readme-ov-file) 

支持使用 React/Vue/Nerv 等框架来开发微信/京东/百度/支付宝/字节跳动/ QQ 小程序/H5/React Native 等应用
